...
z4h load   ohmyzsh/ohmyzsh/plugins/alias-finder
...
alias csd="ssh gxanth@frapa.csd.uoc.gr"
...
#If i want to check what takes space in a folder just run ncdu
#to upload files in terminal
